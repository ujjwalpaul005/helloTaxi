...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorTemplate> userExceptionHandlr(UserException ex, WebRequest req){
	...
	public ResponseEntity<ErrorTemplate> loginExceptionHandlr(LoginException ex, WebRequest req){
		ErrorTemplate myErr = new ErrorTemplate();
	...
	public ResponseEntity<ErrorTemplate> driverExceptionHandlr(DriverException ex, WebRequest req){
		ErrorTemplate myErr = new ErrorTemplate();
